...
public class SellGoodsService extends AsyncTask
{
    ...
    public SellGoodsService(Good good)
    {
        this.statusCode = 0;
        this.good = good;
    }

    public SellGoodsService(int id, String name, int quantity, int price,int updated)
    {
    ...
    protected Object doInBackground(Object[] params) {
        try
        {
            Log.i("SellGoodsService","Starting to sell goods from server");
            ...
            url = new URL("http://10.0.2.2:3000/Good/sell");
            ...
            Log.i("SellGoodsService","Sold goods from server");
